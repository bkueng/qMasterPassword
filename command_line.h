...
public:
	...
	void addParam(const string& name, char short_name=' ', const string& default_val="", const string& task_name="");
...
private:
	...
	vector<string> m_args; //contains an empty element at the end to avoid index checks
	int m_argc;
